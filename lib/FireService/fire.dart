...
class Fire extends StatefulWidget {
  ...
  const Fire({Key? key, this.phoneNumber, this.logedinUserInfo}) : super(key: key);
...
class _FireState extends State<Fire> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: FireBody(phoneNumber: widget.phoneNumber, logedinUserInfo: widget.logedinUserInfo),
