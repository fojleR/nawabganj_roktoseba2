...
class About extends StatefulWidget {
  ...
  const About({Key? key, this.phoneNumber, this.logedinUserInfo}) : super(key: key);
...
class _AboutState extends State<About> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: AboutBody(phoneNumber: widget.phoneNumber, logedinUserInfo: widget.logedinUserInfo),
