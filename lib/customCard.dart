...
class CustomCard extends StatelessWidget {
  ...
  int calculateMonthsPassed() {
    ...
    if (currentDate.month < lastDonationDateTime.month) {
      monthsPassed--;
    }
    return monthsPassed;
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Container(
                color: monthsPassed > 3 && offTimeee >= timeInt? Colors.green: Colors.red,
                width: double.infinity,
                padding: EdgeInsets.all(8.0),
                child: Text(
                  monthsPassed > 3 && offTimeee >= timeInt? "রক্তদানের সময় হয়েছে" : "রক্তদানের সময় হয়নি",
