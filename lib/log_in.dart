...
class _LogInState extends State<LogIn> {
  ...
  void fetchDonorData() async {
    ...
    // Clear the donorInfo list before populating it again
    donorInfo.clear();
    ...
    if (donorData.isEmpty) {
      ...
      donorData.forEach((doc) {
        ...
        String village = data['presentVillage'] ?? '';
        String union = data['presentUnion'] ?? '';
        String upazilla = data['presentUpazilla'] ?? '';
        String gender = data['gender'] ?? '';
        String lastDonationDate = data['lastDonationDate'] ?? '';
        String lastDonationMonth = data['lastDonationMonth'] ?? '';
        String lastDonationYear = data['lastDonationYear'] ?? '';
        String admin = data['admin'] ?? '';
        String birthDate = data['birthDate'] ?? '';
        String birthMonth = data['birthMonth'] ?? '';
        String birthYear = data['birthYear'] ?? '';
        String offTime = data['offTime'].toString() ?? '';
        String cause_of_off = data['cause_for_donation_of'] ?? '';
        String offDate = data['offDate'] ?? '';
        String offMonth = data['offMonth'] ?? '';
        String offYear = data['offYear'] ?? '';
  ...
  void handleLogin() {
    ...
    if (isMobileNumberValid) {
      // If the mobile number is valid, navigate to the Home screen
      // Navigator.pushAndRemoveUntil(
      //   context,
      //   MaterialPageRoute(builder: (context) => HomeActivity(phoneNumber: enteredMobileNumber, logedinUserInfo: loggedInUser)),
