...
class Contact extends StatefulWidget {
  ...
  const Contact({Key? key, this.phoneNumber, this.logedinUserInfo}) : super(key: key);
...
class _ContactState extends State<Contact> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: ContactBody(phoneNumber: widget.phoneNumber, logedinUserInfo: widget.logedinUserInfo),
