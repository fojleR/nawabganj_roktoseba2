...
class Police extends StatefulWidget {
  ...
  const Police({Key? key, this.phoneNumber, this.logedinUserInfo}) : super(key: key);
...
class _PoliceState extends State<Police> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: PoliceBody(phoneNumber: widget.phoneNumber, logedinUserInfo: widget.logedinUserInfo),
