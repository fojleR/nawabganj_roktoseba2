...
class Ambulance extends StatefulWidget {
  ...
  const Ambulance({Key? key, this.phoneNumber, this.logedinUserInfo}) : super(key: key);
...
class _AmbulanceState extends State<Ambulance> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: AmbulanceBody(phoneNumber: widget.phoneNumber, logedinUserInfo: widget.logedinUserInfo),
