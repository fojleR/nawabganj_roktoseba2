...
class Hospital extends StatefulWidget {
  ...
  const Hospital({Key? key, this.phoneNumber, this.logedinUserInfo}) : super(key: key);
...
class _HospitalState extends State<Hospital> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      body: HospitalBody(phoneNumber: widget.phoneNumber, logedinUserInfo: widget.logedinUserInfo),
