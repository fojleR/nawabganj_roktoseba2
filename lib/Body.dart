...
class _BodyState extends State<Body> {
  ...
  void handleButton(BuildContext context) {
    // print("hello handle button");
    // Navigator.of(context).popUntil((route) {
    //   print('Route: ${route.settings.name}');
    //   return true; // Keep iterating until the end of the stack
    // });
            ...
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Body(loggedInUserInfo: widget.loggedInUserInfo)),
                  );
                },
                child: Text("OK"),
              ),
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => HomeActivity(logedinUserInfo: widget.loggedInUserInfo, phoneNumber: widget.loggedInUserInfo!['mobile'])),
          );
        },
        child: Column(
          children: [
